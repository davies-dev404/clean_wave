...
import { api, type InsertBooking } from "@shared/routes"; // Verify @shared/routes exports these
...
export function useContactInquiry() {
  ...
  return useMutation({
    mutationFn: async (data: any) => { // Type should be InsertContact from schema ideally
