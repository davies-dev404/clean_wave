...
export default function Booking() {
    ...
    return (<div className="pt-24 pb-20 min-h-screen bg-slate-50">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <FormField control={form.control} name="serviceType" render={({ field }) => (<FormItem>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                   <FormField control={form.control} name="date" render={({ field }) => (<FormItem className="flex flex-col">
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <FormControl>
                              <Button variant={"outline"} className={cn("h-12 w-full pl-3 text-left font-normal rounded-xl", !field.value && "text-muted-foreground")}>
                  ...
                  <FormField control={form.control} name="sizeOrWeight" render={({ field }) => (<FormItem>
                        <FormLabel>Size / Weight (Optional)</FormLabel>
                        <FormControl>
                          <Input placeholder="e.g. 2 Bedroom or 5kg laundry" className="rounded-xl h-12" {...field} value={field.value || ""}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>
                </div>
                ...
                <FormField control={form.control} name="instructions" render={({ field }) => (<FormItem>
                      ...
                      <FormControl>
                        <Textarea placeholder="Gate code, specific stains to watch out for, etc." className="rounded-xl min-h-[100px]" {...field} value={field.value || ""}/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>)}/>
